...
1. [Datos de más de 60 estaciones en la cuenca del río Usumacinta.](http://172.16.19.27:3000/databases/UsumacintaDatos.zip)
1. [Datos de 14 estaciones en la cuenca del río Conchos.](http://172.16.19.27:3000/databases/ConchosDatos.zip)
1. [Información geográfica de ubicación las estaciones registradas en CLICOM.](http://172.16.19.27:3000/databases/Estaciones.csv)
...
![Apariencia general de CubOps](CubOpsGral.png)
...
![Ejemplo de estructura de directorios con archivos CSV](DirStruct.png)
...
![Colección de datos](ColeccionDatos1.png)
...
![Botones para la _subida_ de archivos de datos](ColeccionDatos2.png)
...
![Armado de la estructura de información](ColeccionDatos4.png)

## Descarga y recarga de la estructura de información
...
![La estructura de la información](Cubote.png)
...
![Conjunto de variables que pueden ser revisadas](SelVar.png)
...
![Tabla correspondiente a una variable](SelVar1.png)
...
## Selección de variables y operaciones
...
# Operaciones estadísticas sobre columnas completas
...
![Menú de operaciones](SelOper.png)
...
![Operación de _un solo resultado_ (mediana)](SelOper1.png)
...
## Operaciones con más de un resultado: cuantiles
...
![Cuartiles para cada una de las columnas](SelOper2.png)
...
![Terciles para cada una de las columnas](SelOper3.png)
...
# Estratificaciones de datos y operaciones sobre ellas
...
## Definición de una estratificación en CubOps
...
![Resultados de una operación estratificada](OpEstratif.png)
...
## Estratificaciones y operaciones con resultados múltiples
...
![Terciles para datos estratificados](EstratifMultpl.png)

## Aplicación recurrente de operaciones
...
![Selección de la variable precipitación](Recurr0.png)
...
![Acumulación de precipitaciones por mes](Recurr1.png)
...
![Promedios de precipitaciones acumuladas mensuales](Recurr2.png)

# Gráficas sencillas con CubOps
...
## Gráficos de información completa de estaciones (columnas)
...
![Producción de gráficos con **CubOps**](Graf1.png)
...
![Otros controles en las gráficas](Graf2.png)

## Algunos usos de los gráficos
...
![Gráfica de los cuantiles](Graf3.png)
...
![Gráfica tipo _boxplot_](Graf4.png)
...
![Climatología de precipitaciones acumuladas mensuales](Graf5.png)
